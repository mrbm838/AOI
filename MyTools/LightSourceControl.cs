...
namespace MyTools
{
    public partial class LightSourceControl : Form
    {
        ...
        private void LightSourceControl_Load(object sender, EventArgs e)
        {
            textBox_COMName.Text = "";
            textBox_ChannelIndex.Text = "1";
            textBox_Intensity.Text = "255";
            textBox_COMName.Text = "COM6";
            textBox_SN.Text = "AA53190328";
            textBox_IP.Text = "192.168.4.16";
        }
        ...
        private void button_OpenChannel_Click(object sender, EventArgs e)
        {
            if (OPTController.TurnOnChannel(Convert.ToInt32(textBox_ChannelIndex.Text)) == 0)
            {
                ...
                StringBuilder bd = new StringBuilder(0,1024);
                OPTController.ReadSN(bd);
                textBox_Status.Text = bd.ToString();
            }
            else
            {
